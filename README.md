...
1. <pre><b>sampleCopy the code behind one of the Vega-lite examples into the Vega-lite editor code</b><pre>. Make some changes to the vega-lite code to see whats possible.
